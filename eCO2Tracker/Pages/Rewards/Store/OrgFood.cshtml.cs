...
{
    public class OrgFoodModel : PageModel
    {
        private readonly ShopItemService _shopItemService;
        private readonly UserService _userService;
        private readonly User_ShopItemService _userShopItemService;
        private IWebHostEnvironment _environment;
        public OrgFoodModel(ShopItemService shopItemService, UserService userService, User_ShopItemService userShopItemService, IWebHostEnvironment environment)
        {
        ...
        public List<ShopItem> OrgFoodList { get; set; } = new();
        ...
        public void OnGet()
        {
            ...
            OrgFoodList = _shopItemService.GetShopItemByTypeDesc("OrgFood");
        }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (ItemBought.ItemCount > 0 && User.PointsCurrent >= ItemBought.ItemPrice)
            {
                ...
                return Redirect("/Rewards/Store/OrgFood");
            }
